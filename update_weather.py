...
def fetch_weather(city_name=None, latitude=None, longitude=None):
    """Fetch only temperature data from OpenWeather API using city name or coordinates."""
...
def update_weather():
    """Fetch districts from Supabase, get temperature data, and update the table."""
