...
def fetch_weather_and_forecast(latitude, longitude):
    ...
    api_key = OPENWEATHER_API_KEYS[0]  # Cycle through your API keys by index or round-robin method
...
def fetch_air_quality(latitude, longitude):
    ...
    api_key = OPENWEATHER_API_KEYS[0]  # Use the same key or cycle through keys
